...
describe WordsController do
  ...
  describe "delete tags for word" do
    ...
    it "should return deleted given a correct tag with existing word" do
      attrs = {:word_id => @word.id, :tag => 'stared'}
      post :delete_tag, :word => attrs

      response.should contain("deleted")
    end

    it "should return failure given a none existing word" do
      attrs = {:word_id => 999, :tag => 'greeting'}
      post :delete_tag, :word => attrs
     ...
     it "should return failure given a none existing tag" do
       attrs = {:word_id => @word.id, :tag => ''}
       post :delete_tag, :word => attrs
   ...
   it "should return failure given word and tag has no relation" do
     attrs = {:word_id => @word.id, :tag => 'imoportant'}
     post :delete_tag, :word => attrs
